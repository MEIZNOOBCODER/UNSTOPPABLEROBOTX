...
import UnstoppableRobot.modules.sql.notes_sql as sql
from UnstoppableRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from UnstoppableRobot.__main__ import DATA_IMPORT
...
from UnstoppableRobot.modules.sql import disable_sql as disabledsql

# from UnstoppableRobot.modules.sql import cust_filters_sql as filtersql
# import UnstoppableRobot.modules.sql.welcome_sql as welcsql
import UnstoppableRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("UnstoppableRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        ...
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `UnstoppableRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("UnstoppableRobot{}.backup".format(chat_id))  # Cleaning file
