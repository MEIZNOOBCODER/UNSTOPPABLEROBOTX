...
from UnstoppableRobot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from UnstoppableRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from UnstoppableRobot.modules.sql import disable_sql as sql
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            enable_module = "UnstoppableRobot.modules." + args[0].rsplit(".", 1)[0]
