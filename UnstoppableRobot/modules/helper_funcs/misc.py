...
from UnstoppableRobot import NO_LOAD
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 6 : 6 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("• ʙᴀᴄᴋ •", callback_data="Unstoppable_back"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("• ʙᴀᴄᴋ •", callback_data="Unstoppable_back")]]
