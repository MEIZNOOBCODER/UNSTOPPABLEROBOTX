...
buttons = [
    [
        InlineKeyboardButton(
            text="•ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ​•", url="t.me/misslisa_robot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
