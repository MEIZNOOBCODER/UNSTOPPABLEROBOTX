#Dekh kya rha hai Unstoppable ko gand dega kya .
...
from UnstoppableRobot.modules import ALL_MODULES
from UnstoppableRobot.modules.helper_funcs.chat_status import is_user_admin
from UnstoppableRobot.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
<b>ʜᴇʏ, ʙᴀʙʏ ✨✌️
ɪ ᴀᴍ <a href='https://t.me/Queen_musbot'>•ᴜɴⓢᴛᴏᴘᴘᴀʙʟᴇ ʀᴏʙᴏᴛ•</a>

ɪ ᴀᴍ ᴛʜᴇ ᴍᴏsᴛ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴀɴᴅ ᴍᴜsɪᴄ ʙᴏᴛ ᴏꜰ ᴛᴇʟᴇɢʀᴀᴍ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="•ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ​•", url="t.me/Queen_musbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
            text="•ᴀʙᴏᴜᴛ ᴍᴇ​​•", callback_data="Unstoppable_"),
        InlineKeyboardButton(
            text="•sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ•", callback_data="bot_source"),
    ], 
    [
        InlineKeyboardButton(
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("UnstoppableRobot.modules." + module_name)
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_text(
            "» ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs ᴏғ [•ᴜɴⓢᴛᴏᴘᴘᴀʙʟᴇ ʀᴏʙᴏᴛ•].",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5369590180 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(UnstoppableRobot_about_callback, pattern=r"Unstoppable_")
