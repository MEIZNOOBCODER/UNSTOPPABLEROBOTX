...
from UnstoppableRobot import MONGO_DB_URI
from UnstoppableRobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import UnstoppableRobot.events

        path = Path(f"UnstoppableRobot/modules/{shortname}.py")
        name = "UnstoppableRobot.modules.{}".format(shortname)
        ...
        mod.Unstoppablerobot = Unstoppable robot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["UnstoppableRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "UnstoppableRobot/modules/*.py"
